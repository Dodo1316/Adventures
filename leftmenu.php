            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class='<?php echo $page=='/project/courses.php'?'active-link':''; ?>'>
                        <a href="courses.php"><i class="fa fa-table "></i>Courses<span class="badge"></span></a>
                    </li>

                    <li class='<?php echo $page=='/project/students.php'?'active-link':''; ?>'>
                        <a href="students.php"><i class="fa fa-table "></i>Students<span class="badge"></span></a>
                    </li>
                    
                    <li class='<?php echo $page=='/project/prices.php'?'active-link':''; ?>'>
                        <a href="prices.php"><i class="fa fa-table "></i>Prices<span class="badge"></span></a>
                    </li>
                </ul>
            </div>
