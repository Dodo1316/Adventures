        ...
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            ...
            <div class="pricing-head">
              <h4><?php echo $row1['duration'] ?></h4>
              <span class="fa fa-usd curency"></span> <span class="amount"><?php echo $row1['amount'] ?></span>
            </div>

            <!-- Plean Detail -->
            <div class="price-in mart-15">
              <a href="#" class="btn btn-bg green btn-block">Know More</a>
            </div>
          </div>
        </div>
        <?php } ?>
